...
const Apple = () => {
  ...
  useEffect(() => {
    window
      .fetch(
        "https://newsapi.org/v2/everything?q=apple&from=2024-01-04&to=2024-01-04&sortBy=popularity&apiKey=85be68df389d4c708f95373c8e4c3090"
      )
      .then((x) => {
        return x.json();
      })
